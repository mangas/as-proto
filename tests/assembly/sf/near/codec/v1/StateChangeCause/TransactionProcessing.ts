...
export class TransactionProcessing {
  static encode(message: TransactionProcessing, writer: Writer): void {
  ...
  static decode(reader: Reader, length: i32): TransactionProcessing {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new TransactionProcessing();
